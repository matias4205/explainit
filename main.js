...
class ExplainIt {
                ...
                <div class="card__content">
                  <ul class="stack">
                    <li class="stack__item">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.998 35.952">
                    ...
                    <li class="stack__item">
                      <svg id="gatsby" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                    ...
                    <li class="stack__item">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 21.772">
                    ...
                    <li class="stack__item">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 28.387">
  ...
  initWidget() {
    rootElm = this.rootElm || document.querySelector('body');
    this.rootElm.innerHTML = this.widgetHTML;
  }
}
