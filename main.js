        ...
        <div class="frame__inner">
          <div class="header">
            ...
            <div class="header__content">
              <h1 class="title">Petgram</h1>
              <p class="shortDescription">
                Petgram es una aplicación realizada en el curso de React Avanzado en Platzi.
                Es una aplicación similar a Instagram con el detalle que las imágenes que se muestran son de mascotas.
              </p>
            </div>
          </div>
          <div class="content">
              ...
              <div class="card">
                ...
                <div class="card__content">
                  <p>
                    ...
                    mascotas. Este proyecto fue realizado en el curso de React Avanzado en Platzi.
                  </p>
                  ...
                  <p>Justo aca 👉 <a>https://petgram-seven-ochre.vercel.app/</a> </p>
                </div>
              </div>
            </div>
          </div>
...
const explainit = new ExplainIt({
  title: 'Petgram',
  shortDescription: 'Sarasear',
  description: 'Salalalalala',
  stack: ['graphQl', 'next', ],
});